...
#////                                                                       ////
#////                      MAO RECORD?                                      ////
#////                     CANTUMIN PEMBUAT SCRIPTNYA LAH                    ////
#////                       YT:Ilangqwer                                    ////
#////                       YT:Dunia Script                                 ////
#////                                                                       ////
#////                                                                       ////
...
mulai (){
    ...
    if [ $lagi = "y" ]; then
            ...
            echo "Terimakasih sudah menggunakan Tols gajelas ini:v"
    fi
}
#spam
spam(){
    ...
    if [ $pilih = "1" ]; then
        ...
        echo "Terimakasih sudah menggunakan Tols gajelan ini:v"
        close
    else
        clear
        echo "Kesalahan"
...
clear
troll
echo Selamat datang , Siapa nick Lu? #tulisan keluar
